...
var dir = 'http://10.0.1.4/listaesperagm/legm/';
...
function retraso(retraso, horaSalida){
	...
	if(retrasoMenos.length>1){
		...
		return '<p style=\" \"><div style=\"font-size:18px;width:100px; height:50px; float:left; margin-left:-70px; padding-top:15px; padding-left:5px; margin-top:-60px; background-image: url(recursos/img/retrasado.png) !important; background-repeat: no-repeat; color:#FFFFFF; font-weight:bold;\">'+ret+'</div></p>'
		...
		return '<p style=\" \"><div style=\"font-size:16px;width:100px; height:50px; float:left; margin-left:-70px; padding-top:15px; padding-left:5px; margin-top:-60px; background-image: url(recursos/img/atiempo.png) !important; background-repeat: no-repeat; color:#FFFFFF; font-weight:bold;\">'+retraso+'</div></p>'
	}	
}
	...
	if(dtsLlamando.getCount()>0){
		if(!wnd){
			...
			var w = new Ext.Window({
					...
					closable : false,
					closeAction : 'close',
					html : '<center><p style=\"font-size:50px; font-weight:none; background-color:#0e3ebc; color:#FFFFFF; \ "><img src=\"recursos/img/usuarioLlamando.png\">&nbsp;&nbsp;Llamando....</p></center><br>' +
							'<center><p style=\"font-size:38px; font-weight:none;\ ">Sr(a). <b><br>' +  dtsLlamando.getAt(0).get('nombre_apellido') + '</b><br>' + 'Por Favor con: <br><b>' + dtsLlamando.getAt(0).get('cargo') + '</b><br>Tiempo Estimado en Atenci&oacute;n: <br><b>'  + dtsLlamando.getAt(0).get('tiempo_atencion') + '</b></p></center>'    
				})
				w.show();
				var s = new air.Sound(); 
